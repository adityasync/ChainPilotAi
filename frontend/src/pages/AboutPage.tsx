    ...
    <div className="min-h-screen bg-black text-white">
      ...
      >
        ...
        <div className="relative max-w-[860px] mx-auto text-center">
          ...
          <h1
            className={`text-[clamp(40px,7vw,72px)] font-bold tracking-[-0.04em] text-white leading-[1.05] mb-6 transition-all duration-700 ease-out delay-100 ${
          ...
          <p
            className={`text-[clamp(17px,2vw,21px)] text-white/40 font-light max-w-[620px] mx-auto transition-all duration-700 ease-out delay-200 ${
      ...
      <section className="px-6 pb-24">
        <div className="max-w-[760px] mx-auto">
          <div className="rounded-[24px] border border-white/[0.06] bg-white/[0.02] p-10 md:p-14">
            <p className="text-[12px] font-semibold text-[#0a84ff] tracking-[0.1em] uppercase mb-4">
              Our mission
            </p>
            <p className="text-[clamp(20px,2.5vw,26px)] leading-[1.5] text-white/85 font-light tracking-[-0.01em]">
            ...
            <p className="mt-6 text-[15px] leading-[1.7] text-white/50 font-light">
      ...
      <section className="px-6 pb-24">
        <div className="max-w-[1000px] mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
          {stats.map((s) => (
            ...
            >
              <p className="text-[clamp(32px,4vw,44px)] font-bold tracking-[-0.03em] text-white mb-1">
                {s.value}
              </p>
              <p className="text-[12px] text-white/40 font-light leading-[1.4]">
                {s.label}
              </p>
            </div>
          ))}
      ...
      <section className="px-6 pb-24">
        <div className="max-w-[1100px] mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-[clamp(32px,5vw,48px)] font-bold tracking-[-0.02em] text-white mb-3">
              What we believe
            </h2>
            <p className="text-[16px] text-white/40 font-light max-w-[480px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {values.map((v) => (
              <div
                key={v.title}
                className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 hover:bg-white/[0.03] transition-colors duration-300"
              >
                <div
                ...
                <p className="text-[14px] leading-[1.6] text-white/50 font-light">
                  {v.desc}
                </p>
              </div>
            ))}
      ...
      <section className="px-6 pb-24">
        <div className="max-w-[900px] mx-auto">
          <div className="rounded-[24px] border border-white/[0.06] bg-white/[0.02] p-10 md:p-14">
            ...
            <h2 className="text-[clamp(24px,3.5vw,36px)] font-bold tracking-[-0.02em] text-white mb-6 leading-[1.2]">
              Teams that run real supply chains and need answers today.
            </h2>
            <ul className="space-y-3 text-[15px] leading-[1.7] text-white/60 font-light">
      ...
      <section className="px-6 pb-32">
        <div className="max-w-[800px] mx-auto text-center">
          <h2 className="text-[clamp(32px,5vw,48px)] font-bold tracking-[-0.02em] text-white mb-4 leading-[1.15]">
            Ready to see it on your data?
          </h2>
          <p className="text-[16px] text-white/40 font-light mb-8 max-w-[460px] mx-auto">
